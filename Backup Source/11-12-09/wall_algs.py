...
def trap(walls):
    i_1_4 = walls.shape[0] // 4
    i_2_4 = 2 * i_1_4
    i_3_4 = 3 * i_1_4
    walls[i_1_4:i_3_4 + 1, i_1_4] = True
    walls[i_1_4:i_3_4 + 1, i_3_4] = True
    walls[i_1_4, i_1_4:i_3_4 + 1] = True
    walls[i_3_4, i_1_4:i_3_4 + 1] = True

    walls[i_2_4, i_3_4] = False
    return walls
